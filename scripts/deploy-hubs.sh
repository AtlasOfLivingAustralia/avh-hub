...
cp hubs-webapp-1.0-SNAPSHOT.war /usr/share/tomcat6/webapps/avh.war
...
mv /usr/share/tomcat6/webapps/avh-demo/WEB-INF/classes/hubs.properties.AVH /usr/share/tomcat6/webapps/avh/WEB-INF/classes/hubs.properties
...
cd /usr/share/tomcat6/webapps/avh/WEB-INF/
sed  's/>ala</>avh</g' < web.xml  | sed 's/localhost:8080/avh.ala.org.au/g' > web.xml.avh
