...
<div id="indentContent">
    ...
    <div id="partners">
        <div class="row">
                <div class="column col1"><img alt="Western Australian Herbarium, Department of Environment and Conservation" src="/static/images/avh2012/logo_PERTH.jpg"/></div>
        ...
        <div class="row">
                <div class="column col1"><img alt="Herbarium of the Northern Territory Parks &amp; Wildlife Commission NT" src="/static/images/avh2012/logo_DNA.jpg"/></div>
        ...
        <div class="row">
                <div class="column col1">
                        <img alt="State Herbarium of South Australia Plant Biodiversity Centre" src="/static/images/avh2012/logo_AD.jpg"/>
                </div>
        ...
        <div class="row">
        <div class="column col1">
                <img alt="Queensland Herbarium Environmental Protection Agency" src="/static/images/avh2012/logo_BRI.jpg"/>
        </div>
        ...
        <div class="row">
                <div class="column col1">
                        <img alt="National Herbarium of New South Wales Royal Botanic Gardens Sydney" src="/static/images/avh2012/logo_NSW.jpg"/>
                </div>
        ...
        <div class="row">
                <div class="column col1">
                        <img alt="Australian National Herbarium Centre for Plant Biodiversity Research" src="/static/images/avh2012/logo_CANB.jpg"/>
                </div>
        ...
        <div class="row">
                <div class="column col1">
                        <img alt="National Herbarium of Victoria Royal Botanic Gardens Melbourne" src="/static/images/avh2012/logo_MEL.jpg"/>
                </div>
        ...
        <div class="row">
                <div class="column col1">
                        <img alt="Tasmanian Herbarium Tasmanian Museum and Art Gallery" src="/static/images/avh2012/logo_HO.jpg"/>
                </div>
        ...
        <div class="row">
                <div class="column col1">
                        <img alt="Australian Tropical Herbarium" src="/static/images/avh2012/logo_ATH.jpg"/>
                </div>
        ...
        <div class="row">
                <div class="column col1"><img alt="New Zealand Virtual Herbarium" src="/static/images/avh2012/logo_NZVH.jpg"/></div>
                <div class="column col2">The <a href="http://www.virtualherbarium.org.nz/home"><b>New Zealand Virtual Herbarium</b></a> (NZVH)</div>
        </div>
        <div class="row">
                <div class="column col1"><img alt="Australian Biological Resources Study" src="/static/images/avh2012/logo_ABRS.jpg"/></div>
