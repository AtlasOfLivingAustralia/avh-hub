            ...
            <div class="span12">
                <div class="tabbable">
                    <ul class="nav nav-tabs" id="searchTabs">
                        ...
                        <li><a id="t4" href="#catalogUpload" data-toggle="tab">Batch accession no. search</a></li>
                    ...
                    <div id="advanceSearch" class="tab-pane">
                        <form name="advancedSearchForm" id="advancedSearchForm" action="${pageContext.request.contextPath}/advancedSearch" method="POST">
                            ...
                            <div class="toggleSectionXXX" id="extendedOptionsXXXX">
                                ...
                                <div class="toggleSection">
                                    <table border="0" width="100" cellspacing="2" class="compact">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="labels">Accession number</td>
                                                <td>
                                            ...
                                            <tr>
                                                <td class="labels">Conservation status</td>
                                                <td>
                                            ...
                                            <tr>
                                                <td class="labels">Seed quantity (adjusted)</td>
                                                <td>
                                            ...
                                            <tr>
                                                <td class="labels">Seed viability (summary)</td>
                                                <td>
                                                    ...
                                                    <br/>
                                                    <div id="viability-range" style="width:200px;height:10px;margin-top:10px;float:left;margin-right:10px;"></div>
                                                    <button class="btn btn-small" onclick="$('.seed_viability').val('');return false;">clear values</button>
                                ...
                                &nbsp;&nbsp;
                                <input type="reset" class="btn" value="Clear all" id="clearAll" onclick="$('input#solrQuery').val(''); $('input.clear_taxon').click(); return true;"/>
